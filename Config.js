$(document).ready(function () {
    ...
    $(document).off('click', '#tbProcedimeintos tr td button').on("click", "#tbProcedimeintos tr td button", function (event) {
        event.preventDefault();
    ...
    $(document).off('click', '#tbTablas tr td button').on("click", "#tbTablas tr td button", function (event) {
        event.preventDefault();
    ...
    $(document).off('click', '#btnAddReporte').on("click", "#btnAddReporte", function (event) {
        event.preventDefault();
        $('#modalReporte').modal('toggle');
    });


    $(document).off('click', '#tbReportes tr td button').on("click", "#tbReportes tr td button", function (event) {
        event.preventDefault();
